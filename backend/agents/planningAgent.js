...
4. If "emergency_beds_available" is 0, do NOT route to that hospital. You MUST check the next nearest hospital.
5. Repeat this process until you find the closest operational hospital with emergency_beds_available > 0.
...
Return ONLY this JSON, no extra text:
{
  "response_plan": {
    ...
    "actions": [
      {
        ...
        "instruction": "Dispatch from source to Gulshan Chowrangi, pick up heatstroke victims, and transport to [hospital name]",
    ...
    "hospital_routing": {
      ...
      "reasoning": "Explain why this hospital was chosen over others (e.g. nearest hospital Liaquat was full, so rerouted to Aga Khan)"
    },
    "public_message": {
